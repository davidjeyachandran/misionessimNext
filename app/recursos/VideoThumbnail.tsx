...
import { VideoLightbox } from "../_components/VideoLightbox";
 ...
 * (live: the ElementsKit video widget absolutely positioned over
 * .elementor-element-558cc0f).
 *
 ...
 */
export function VideoThumbnail({ image, videoId, label }: VideoThumbnailProps) {
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute left-1/2 top-1/2 grid h-[82px] w-[82px] -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-white/20 text-white transition-colors hover:bg-white/35 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
      >
        <span
          aria-hidden
